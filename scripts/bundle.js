...
var createTodo = function createTodo(toDoTxt) {
  toDo.push({
    _id: (0,uuid__WEBPACK_IMPORTED_MODULE_0__["default"])(),
    task: toDoTxt,
    completed: false
  });
  saveTodos();
...
var removeTodo = function removeTodo(id) {
  var taskIndex = toDo.findIndex(function (task) {
    return task._id === id;
  });
  if (taskIndex > -1) {
...
var toggleTodo = function toggleTodo(id) {
  var task = toDo.find(function (task) {
    return task._id === id;
  });
  if (task) {
...
var renderTodo = function renderTodo() {
  var todoDiv = document.getElementById('to-do-list');
  var list = (0,_todos__WEBPACK_IMPORTED_MODULE_0__.getTodos)();
  ...
  var incompleteTasks = list.filter(function (task) {
    return !task.completed;
  });
  var filteredList = list.filter(function (task) {
    var textMatchFilter = task.task.toLocaleLowerCase().includes(searchText.toLocaleLowerCase());
    var hideCompletedFilter = !hideCompleted || !task.completed;
    return textMatchFilter && hideCompletedFilter;
  });
  todoDiv.innerHTML = "";
  if (filteredList.length > 0) {
    todoDiv.appendChild(generateSummaryDOM(incompleteTasks));
    filteredList.forEach(function (task, index) {
...
var generateTodoDOM = function generateTodoDOM(task, index) {
  //create elemets: div, checkbox, text and button
  var taskEl = document.createElement('label');
  ...
  checkbox.addEventListener('change', function (e) {
    (0,_todos__WEBPACK_IMPORTED_MODULE_0__.toggleTodo)(task._id);
    renderTodo();
  });

  //working with text
  newP.textContent = "Task ".concat(index + 1, ": ").concat(task.task);

  //working with button
  button.textContent = 'Remove';
  button.classList.add('button', 'button--text');
  button.addEventListener('click', function () {
    (0,_todos__WEBPACK_IMPORTED_MODULE_0__.removeTodo)(task._id);
    renderTodo();
  });
...
var generateSummaryDOM = function generateSummaryDOM() {
  var summary = document.createElement('p');
  summary.classList.add('list-title');
  var list = (0,_todos__WEBPACK_IMPORTED_MODULE_0__.getTodos)();
  var ending = list.length === 1 ? '' : 's';
  summary.textContent = "You have ".concat(list.length, " task").concat(ending, " to do");
  return summary;
};
...
(0,_views__WEBPACK_IMPORTED_MODULE_0__.renderTodo)();

//Add a task to the to do list
var addTask = function addTask(e) {
  e.preventDefault();
  var inpVal = e.target.elements.addTaskInp.value.trim();
  if (inpVal.length > 0) {
    (0,_todos__WEBPACK_IMPORTED_MODULE_1__.createTodo)(inpVal);
    (0,_views__WEBPACK_IMPORTED_MODULE_0__.renderTodo)();
...
//Event handlers
document.getElementById('txt-filter').addEventListener('input', function (e) {
  (0,_filters__WEBPACK_IMPORTED_MODULE_2__.setFilters)({
...
document.getElementById('hide-comp-check').addEventListener('change', function (e) {
  (0,_filters__WEBPACK_IMPORTED_MODULE_2__.setFilters)({
...
window.addEventListener('storage', function (e) {
  if (e.key === 'toDoList') {
    (0,_todos__WEBPACK_IMPORTED_MODULE_1__.loadTodos)();
    (0,_views__WEBPACK_IMPORTED_MODULE_0__.renderTodo)();
  }
});
})();
